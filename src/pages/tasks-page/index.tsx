        ...
        <div style={{ height: '100%' }}>
            <section className={styles.rootWrapper}>
                <div className={styles.header}>
                        ...
                        <div
                            className={
                                project.status === 'progress'
                                    ...
                                    : stylesJoint(styles.projectStatus, styles.projectDone)
                            }
                        >
                    ...
                    <p
                        onClick={() => dispatch(showModal({ type: 'task', action: 'add', id: projectId }))}
                        className={styles.addTask}
                    >
                        <IoIosAddCircleOutline style={{ color: 'rgb(237, 171, 18)' }} />
                        Add new task
                    </p>
                </div>
